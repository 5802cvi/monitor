...
using MonitorCreator.Converters;
...
namespace MonitorCreator
{
    ...
    public partial class MainWindow : Form
    {
        ...
        public MainWindow(KompasObject kompas)
        {
            ...
            _modelBuilder = new ModelBuilder(kompas);
        }
        ...
        private void BuildModel()
        {
            ...
            {
                _modelBuilder.Build(parameters);
            }
            else
            {
                //TODO:
        ...
        private Dictionary<Parameter, ParameterData> GetModelParameters()
        {
            ...
            {
                //TODO:
                double? value = GetParameterValue(parameter.Value.Text);
        ...
        private void TеxtBox_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void TextBox_Leave(object sender, EventArgs e)
        {
            ...
            if (double.TryParse(textBox.Text, out result) == false)
              //  textBox.Text.LastIndexOf(',', textBox.TextLength - 1) == 0);
            {
                MessageBox.Show(
